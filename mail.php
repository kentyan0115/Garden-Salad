...
$re_subject = "TF Garden Salad（自動返信メール）";
...
その他ご不明点がございましたら、お手数ですが下記の連絡先まで、
...
.confirm__submit {
	background: rgba(251, 226, 16, 0.8);
	margin-left: 20px;
	padding-top: 2px;
...
<div class="confirm__flex">
	<input class="confirm__btn" type="button" value="前画面に戻る" onClick="history.back()"></p>
	<input class="confirm__btn confirm__submit" type="submit" value="　送信する　">
</div>
</form>
<?php } ?>
</div><!-- /formWrap -->
...
<body>
<div align="center" class="complete">
<?php if($empty_flag == 1){ ?>
<h4>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4>
...
<p align="center">&copy; TF Garden Salad</p>
